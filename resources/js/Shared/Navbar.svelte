...
<nav class="bg-gray-100">
  <div class="max-w-6xl mx-auto px-4">
    <div class="flex justify-between">
      ...
      <!-- secondary nav -->
      <div class="hidden md:flex items-center space-x-1">
        <a href="/l" class="py-5 px-3">Login</a>
        <a href="/s" class="py-2 px-3 bg-yellow-400 hover:bg-yellow-300 text-yellow-900 hover:text-yellow-800 rounded transition duration-300">Signup</a>
      </div>

      <!-- mobile button goes here -->
      <div class="md:hidden flex items-center">
        <button on:click={ handleClick } class="mobile-menu-button">
